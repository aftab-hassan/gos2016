...
public class SudokuValidator_using511 {
...
//		return false;
	...
	static boolean isRowValid(int[][] a)
	{
		for(int i = 0;i<a.length;i++)
		{
			...
			{
				result = result | 1<< (a[i][j]-1);//if the -1 wasn't there, you would have to compare against 
													//10986543210
													//  111111110
													//since 1<<1 would be 10
			}
			if(result != 15)
				return false;
		}
