 ...
 */
public class FindTopKRepeatingCharacters_AliAyyash_forwhile {

    public static void main( String[] args ) {
        FindTopKRepeatingCharacters_AliAyyash_forwhile obj = new FindTopKRepeatingCharacters_AliAyyash_forwhile();
    ...
    public ArrayList<Tuple> findTopKRepeatingCharacters (String str, int k)
    {
        ...
        /* adding to the PriorityQueue based on condition */
        int count = 1;
